...
@interface ViewController : UIViewController <OpenEarsEventsObserverDelegate> {
    ...
    NSString *pathToDynamicallyGeneratedNamesGrammar;
	NSString *pathToDynamicallyGeneratedNamesDictionary;
...
@property (nonatomic, copy) NSString *pathToDynamicallyGeneratedNamesGrammar;
@property (nonatomic, copy) NSString *pathToDynamicallyGeneratedNamesDictionary;
